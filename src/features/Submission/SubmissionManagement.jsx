...
import SubmissionList from './SubmissionList'; // Assuming you have a component named FormList
import { Link } from 'react-router-dom';
import { Button, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
import AddCircleOutlineIcon from '@mui/icons-material/AddCircleOutline';
import './SubmissionManagement.css'; // Make sure to import the correct CSS file
...
function SubmissionManagement() {
    ...
    return (
        <div id='SubmissionManagement'> 
           
            
            <SubmissionList // Assuming this component is for displaying forms
