...
import { faSave, faEdit, faVolumeUp } from '@fortawesome/free-solid-svg-icons'; // Import icon for audio
...
const AudioQuestion = ({ 
    ...
    return (
        <div className="audio-question-editor">
            <div className="icon-container">
                <p className="btn btn-icon" style={{ color: 'green', marginLeft: '0' }}>
                    <FontAwesomeIcon icon={faVolumeUp} /> {/* Changed icon to faVolumeUp */}
                    Audio Question
                </p>
            </div>
