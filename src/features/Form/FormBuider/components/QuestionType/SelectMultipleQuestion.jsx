...
const SelectMultipleQuestions = ({ 
    ...
    const handleSave = () => {
        if (options.length === 0) {
            // If options array is empty, prevent saving
    ...
    return (
        <div className="select-multiple-question-editor">

            <div className="icon-container">
                <p className="btn btn-icon" style={{ color: 'green', marginLeft: '0' }}>
                    <span className="bi bi-ui-checks-grid"></span>
...
export default SelectMultipleQuestions;
